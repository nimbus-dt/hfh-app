...
{% if (!ctx.disabled && (ctx.component.multiple || !ctx.files.length)) { %}
  ...
  {% } else { %}
    <div class="video-container hfh_formio_file_video_container">
      <video class="video hfh_formio_file_video" autoplay="true" ref="videoPlayer"></video>
      <div class="hfh_formio_file_video_frame"></div>
    </div>
    <div class="hfh_formio_file_camera_buttons">
