...
export default function TestCycleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setClosedCycleMessage(initialValues.closedCycleMessage);
    setFormUrl(initialValues.formUrl);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TestCycle(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TestCycleCreateForm")}
      {...rest}
    >
      <TextField
        label="Start date"
