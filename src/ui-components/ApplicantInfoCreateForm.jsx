...
export default function ApplicantInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ApplicantInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ApplicantInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner id"
